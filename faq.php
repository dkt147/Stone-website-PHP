        			...
        			<div class="accordion accordion-rounded" id="accordion-1">
					    ...
					    <div class="card card-box card-sm bg-light">
					        ...
					        <div id="collapse-2" class="collapse" aria-labelledby="heading-2" data-parent="#accordion-1">
					            <div class="card-body">
								Always a mandatory chemical test of the batch by a reputable state of art Lab and a final inspection
before shipment.
					            </div><!-- End .card-body -->
					        </div><!-- End .collapse -->
					    </div><!-- End .card -->
					    ...
					    <div class="card card-box card-sm bg-light">
					        ...
					        <div id="collapse-3" class="collapse" aria-labelledby="heading-3" data-parent="#accordion-1">
					            <div class="card-body">
								Yes, but, “Cost shall be borne in full by the buyer” in Advance.
					            </div><!-- End .card-body -->
					        </div><!-- End .collapse -->
					    </div><!-- End .card -->
					    ...
					    <div class="card card-box card-sm bg-light">
					        <div class="card-header" id="heading-4">
					            <h2 class="card-title">
									...
									Can we be your distributer ?
					                </a>
					            </h2>
					        </div><!-- End .card-header -->
					        <div id="collapse-4" class="collapse" aria-labelledby="heading-4" data-parent="#accordion-1">
					            <div class="card-body">
								Sure, as we are looking for distributors and agents all over the world.
					            </div><!-- End .card-body -->
					        </div><!-- End .collapse -->
					    </div><!-- End .card -->
						...
						<div class="card card-box card-sm bg-light">
					        <div class="card-header" id="heading-6">
					            <h2 class="card-title">
									...
									What’s the * Price / MT US.D ($) ?
					                </a>
					            </h2>
					        </div><!-- End .card-header -->
					        <div id="collapse-6" class="collapse" aria-labelledby="heading-6" data-parent="#accordion-1">
					            <div class="card-body">
								Its, as per Price List:<br>
. *Price might vary subject to change in Freight cost / Taxes or any other unprecedented reason.
					            </div><!-- End .card-body -->
					        </div><!-- End .collapse -->
					    </div><!-- End .card -->
						...
						<div class="card card-box card-sm bg-light">
					        ...
					        <div id="collapse-8" class="collapse" aria-labelledby="heading-8" data-parent="#accordion-1">
					            <div class="card-body">
								Negotiable, but in general.<br>
o 50% Advance &amp; 50% on DC (At sight)<br>
or 100 % “confirmed” irrevocable LC ( At Sight).
					            </div><!-- End .card-body -->
					        </div><!-- End .collapse -->
					    </div><!-- End .card -->
						...
						<div class="card card-box card-sm bg-light">
					        <div class="card-header" id="heading-9">
					            <h2 class="card-title">
									...
									How the packing of product is done ?
					                </a>
					            </h2>
					        </div><!-- End .card-header -->
					        <div id="collapse-9" class="collapse" aria-labelledby="heading-9" data-parent="#accordion-1">
					            <div class="card-body">
								Routinely its done in Polythene Jumbo bags of 1 MT. But it can be done as per requirements of
Buyer.
					            </div><!-- End .card-body -->
					        </div><!-- End .collapse -->
					    </div><!-- End .card -->
						...
						<div class="card card-box card-sm bg-light">
					        ...
					        <div id="collapse-10" class="collapse" aria-labelledby="heading-10" data-parent="#accordion-1">
					            <div class="card-body">
								Usually within* 21 to 50 working days after Confirmation. It depends on quantity and shipping
schedule of carrier vessels.
					            </div><!-- End .card-body -->
					        </div><!-- End .collapse -->
					    </div><!-- End .card -->
						...
						<div class="card card-box card-sm bg-light">
					        ...
					        <div id="collapse-11" class="collapse" aria-labelledby="heading-11" data-parent="#accordion-1">
					            <div class="card-body">
								All orders shipped by Sea.
					            </div><!-- End .card-body -->
					        </div><!-- End .collapse -->
					    </div><!-- End .card -->
						...
						<div class="card card-box card-sm bg-light">
					        <div class="card-header" id="heading-12">
					            <h2 class="card-title">
									...
									Which is port of loading ?
					                </a>
					            </h2>
					        </div><!-- End .card-header -->
					        <div id="collapse-12" class="collapse" aria-labelledby="heading-12" data-parent="#accordion-1">
					            <div class="card-body">
								Port Qasim / Karachi Port, Karachi Pakistan.
					            </div><!-- End .card-body -->
					        </div><!-- End .collapse -->
					    </div><!-- End .card -->
						...
						<div class="card card-box card-sm bg-light">
					        ...
					        <div id="collapse-13" class="collapse" aria-labelledby="heading-13" data-parent="#accordion-1">
					            <div class="card-body">
								As a part of the order, the following information is collected.<br><br>
– Customer Name<br>
– Phone number<br>
– Email<br>
– Location<br>
